...
it('can render properly an h1', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h1" content="Hello folks!" />'
    );
});
...
it('can render properly an h2', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h2" content="Hello folks!" />'
    );
});
...
it('can render properly an h3', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h3" content="Hello folks!" />'
    );
});
...
it('can render properly an h4', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h4" content="Hello folks!" />'
    );
});
...
it('can render properly an h5', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h5" content="Hello folks!" />'
    );
});
...
it('can render properly an h6', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h6" content="Hello folks!" />'
    );
});
...
it('can use a custom color', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title level="h3" color="blue" content="Hello folks!" />'
    );
});
...
it('passes attributes to the component', function () {
    $this->assertComponentRenders(
        ...
        '<x-karter-title x-attribute class="some-class" level="h3" content="Hello folks!" />'
    );
});
